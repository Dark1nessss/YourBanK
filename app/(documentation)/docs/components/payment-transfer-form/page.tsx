  ...
  return (
    <div className="space-y-6 w-full">
      <motion.div
        ...
        className="space-y-2"
      >
        <h1 className="font-ibm-plex-serif text-3xl font-bold text-white md:text-5xl">PaymentTransferForm</h1>
        <p className="text-lg text-gray-400">Form component for initiating bank transfers with validation.</p>
      </motion.div>
      ...
      >
        ...
        <div className="grid gap-4">
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            ...
            <p className="text-gray-400">Array of bank accounts available for transfers.</p>
      ...
      >
        ...
        <div className="grid gap-4">
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            ...
            <p className="text-gray-400">Comprehensive form validation using Zod schema validation.</p>
          </Card>

          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">Loading States</h3>
            <p className="text-gray-400">Visual loading states during form submission with animated indicators.</p>
          </Card>

          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">Bank Integration</h3>
            <p className="text-gray-400">Integration with Dwolla for processing bank transfers.</p>
          </Card>

          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">Transaction Creation</h3>
            <p className="text-gray-400">Automatically creates transaction records for successful transfers.</p>
          </Card>
        </div>
      </motion.div>
    </div>
