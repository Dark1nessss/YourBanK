    ...
    <div className="space-y-6 w-full">
      ...
      >
        ...
        <p className="text-lg text-gray-400">
          A component for displaying transaction categories with visual
          indicators.
        </p>
      </motion.div>
      ...
      >
        ...
        <div className="grid gap-4">
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            ...
            <p className="text-gray-400">
              Visual progress bar showing the category&apos;s proportion of
              total transactions.
            </p>
          </Card>
          ...
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            ...
            <p className="text-gray-400">
              Adapts to different screen sizes while maintaining visual
              hierarchy.
            </p>
          </Card>
        </div>
