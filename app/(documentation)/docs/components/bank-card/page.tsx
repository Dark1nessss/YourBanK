  ...
  return (
    <div className="space-y-6 w-full">
      <motion.div
        ...
        className="space-y-2"
      >
        <h1 className="font-ibm-plex-serif text-3xl font-bold text-white md:text-5xl">BankCard</h1>
        <p className="text-lg text-gray-400">A card component for displaying bank account information and balances.</p>
      </motion.div>
    ...
    />
      ...
      >
        ...
        <div className="grid gap-4">
          ...
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            ...
            <p className="text-gray-400">Whether to show the account balance initially.</p>
            <p className="text-sm text-gray-500 mt-1">Type: boolean (optional, defaults to true)</p>
          </Card>

          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">className</h3>
            <p className="text-gray-400">Additional CSS classes to apply to the card.</p>
      ...
      >
        ...
        <div className="grid gap-4">
          ...
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">Animated Transitions</h3>
            <p className="text-gray-400">
