  ...
  return (
    <div className="space-y-6 w-full">
      <motion.div
        ...
        className="space-y-2"
      >
        <h1 className="font-ibm-plex-serif text-3xl font-bold text-white md:text-5xl">AnimatedCounter</h1>
        <p className="text-lg text-gray-400">A smooth animated counter component for displaying numerical values.</p>
      </motion.div>
        ...
        <Card className="p-6 bg-gray-900/50 border-gray-800">
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <Button onClick={() => setValue((prev) => prev + 100)} className="bg-[#39A36A] hover:bg-[#2E8754]">
                Add $100
              </Button>
              <Button
    ...
    <div className="text-3xl font-bold">
      ...
      >
        ...
        <div className="grid gap-4">
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            ...
            <p className="text-gray-400">The numerical value to display and animate.</p>
            <p className="text-sm text-gray-500 mt-1">Type: number</p>
          </Card>

          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">formatOptions</h3>
            <p className="text-gray-400">Options for number formatting using Intl.NumberFormat.</p>
            <p className="text-sm text-gray-500 mt-1">Type: Intl.NumberFormatOptions (optional)</p>
          </Card>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="grid gap-4">
          ...
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">Intersection Observer</h3>
            <p className="text-gray-400">
          ...
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">Flexible Formatting</h3>
            <p className="text-gray-400">
