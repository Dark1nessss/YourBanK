  ...
  return (
    <div className="space-y-6 w-full">
      <motion.div
        ...
        className="space-y-2"
      >
        <h1 className="font-ibm-plex-serif text-3xl font-bold text-white md:text-5xl">TransactionsTable</h1>
        <p className="text-lg text-gray-400">A feature-rich table component for displaying transaction data.</p>
      </motion.div>
      ...
      >
        ...
        <div className="grid gap-4">
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            ...
            <p className="text-gray-400">Array of transaction objects to display in the table.</p>
            <p className="text-sm text-gray-500 mt-1">
              Type: {"{"}id: string; name: string; amount: number; type?: string; date: string; paymentChannel?: string;
              category?: string{"}"}[]
            </p>
          </Card>
        </div>
      ...
      >
        ...
        <div className="grid gap-4">
          ...
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            ...
            <p className="text-gray-400">Responsive layout with collapsible columns on mobile devices.</p>
          </Card>

          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">Status Indicators</h3>
            <p className="text-gray-400">Visual status badges that automatically update based on transaction date.</p>
          </Card>
        </div>
      </motion.div>
    </div>
