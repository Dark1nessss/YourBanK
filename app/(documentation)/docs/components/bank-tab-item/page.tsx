  ...
  return (
    <div className="space-y-6 w-full">
      <motion.div
        ...
        className="space-y-2"
      >
        <h1 className="font-ibm-plex-serif text-3xl font-bold text-white md:text-5xl">BankTabItem</h1>
  ...
  return (
    ...
    />
      ...
      >
        ...
        <div className="grid gap-4">
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            ...
            <p className="text-gray-400">The bank account object containing account details.</p>
            <p className="text-sm text-gray-500 mt-1">Type: BankAccount</p>
          </Card>

          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">isSelected</h3>
            <p className="text-gray-400">Whether the tab item is currently selected.</p>
            <p className="text-sm text-gray-500 mt-1">Type: boolean</p>
          </Card>

          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">onClick</h3>
            <p className="text-gray-400">Callback function called when the tab item is clicked.</p>
            <p className="text-sm text-gray-500 mt-1">Type: () {"->"} void (optional)</p>
          </Card>

          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">className</h3>
            <p className="text-gray-400">Additional CSS classes to apply to the tab item.</p>
            <p className="text-sm text-gray-500 mt-1">Type: string (optional)</p>
          </Card>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="grid gap-4">
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">Interactive States</h3>
          ...
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">Selection Indicator</h3>
            <p className="text-gray-400">
