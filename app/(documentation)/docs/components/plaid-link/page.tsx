  ...
  return (
    <div className="space-y-6 w-full">
      <motion.div
        ...
        className="space-y-2"
      >
        <h1 className="font-ibm-plex-serif text-3xl font-bold text-white md:text-5xl">PlaidLink</h1>
        <p className="text-lg text-gray-400">Component for connecting bank accounts using Plaid integration.</p>
      </motion.div>
      ...
      >
        ...
        <Card className="p-6 bg-white border-gray-800">
          <div className="space-y-4">
            <div>
              <h3 className="text-sm font-medium text-black mb-2">Primary Variant</h3>
      ...
      >
        ...
        <div className="grid gap-4">
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            ...
            <p className="text-gray-400">Seamless integration with Plaid Link for secure bank account connections.</p>
          </Card>

          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">Token Management</h3>
            <p className="text-gray-400">Automatic handling of link tokens and public token exchange.</p>
          </Card>

          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">Visual Variants</h3>
            <p className="text-gray-400">Multiple button styles to fit different UI contexts.</p>
          </Card>

          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">Client Navigation</h3>
            <p className="text-gray-400">Automatic redirection to dashboard after successful connection.</p>
          </Card>
        </div>
      </motion.div>
    </div>
