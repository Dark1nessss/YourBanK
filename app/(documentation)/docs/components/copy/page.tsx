  ...
  return (
    <div className="space-y-6 w-full">
      <motion.div
        ...
        className="space-y-2"
      >
        <h1 className="font-ibm-plex-serif text-3xl font-bold text-white md:text-5xl">Copy</h1>
        <p className="text-lg text-gray-400">A button component for copying text to clipboard with visual feedback.</p>
      </motion.div>
      ...
      >
        ...
        <div className="grid gap-4">
          ...
          <Card className="p-4 bg-gray-900/50 border-gray-800">
            ...
            <p className="text-gray-400">Automatically resets to the copy icon after 2 seconds.</p>
          </Card>

          <Card className="p-4 bg-gray-900/50 border-gray-800">
            <h3 className="font-semibold text-white mb-2">Clipboard Integration</h3>
            <p className="text-gray-400">Uses the native Clipboard API for reliable text copying.</p>
          </Card>
        </div>
      </motion.div>
    </div>
