  ...
  return (
    <div className="space-y-6 w-full">
      ...
      >
        ...
        <p className="text-lg text-gray-400">Utility functions for common operations.</p>
      </motion.div>
      ...
      <motion.div
        ...
        className="space-y-4"
      >
        <h2 className="font-ibm-plex-serif text-2xl font-bold text-white">Formatting</h2>
        <Card className="p-6 bg-gray-900/50 border-gray-800">
          <p className="text-gray-400 mb-4">Date and currency formatting utilities.</p>
          <CodeBlock
...
const formattedAmount = formatAmount(1234.56) // "$1,234.56"`}
      ...
      >
        ...
        <Card className="p-6 bg-gray-900/50 border-gray-800">
          <p className="text-gray-400 mb-4">URL query parameter manipulation.</p>
          <CodeBlock
