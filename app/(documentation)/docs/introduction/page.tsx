...
import { ArrowRight, BanknoteIcon as Bank, CreditCard, RefreshCcw, Shield } from "lucide-react"
...
export default function IntroductionPage() {
  const features = [
    ...
    },
    {
      ...
      description: "Send and receive money instantly between any connected bank account or card with zero fees.",
    },
    {
      icon: Shield,
    ...
    <div className="space-y-12 w-full">
      ...
      >
        ...
        <p className="text-xl text-gray-400 max-w-3xl">
          YourBanK is revolutionizing the way Americans interact with their finances by providing a unified platform
          that connects multiple bank accounts, credit cards, and financial services into one seamless experience.
        </p>
      </motion.div>
      ...
      <motion.div
        ...
        className="space-y-4"
      >
        <h2 className="font-ibm-plex-serif text-3xl font-bold text-white">Our Platform</h2>
        <div className="grid gap-6 md:grid-cols-2">
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-white">For Individuals</h3>
      ...
      <motion.div
        ...
        className="space-y-4"
      >
        <h2 className="font-ibm-plex-serif text-3xl font-bold text-white">Technology Stack</h2>
