    ...
    <div className="space-y-6 w-full">
      ...
      >
        ...
        <p className="text-gray-400">
          The{' '}
          <code className="rounded bg-[#1d1d1d] px-1.5 py-0.5">
            components.json
          </code>{' '}
          file contains the configuration for your YourBanK components,
          including styling, themes, and component paths.
        </p>
    ...
    "utils": "@/lib/utils"
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-400">
            The style of components to use. YourBanK uses a custom style based
            on shadcn/ui with banking-specific modifications.
          </p>

          <h3 className="text-xl font-semibold text-white">rsc</h3>
          <p className="text-gray-400">
            Enable React Server Components support. This is enabled by default
            for Next.js projects.
          </p>

          <h3 className="text-xl font-semibold text-white">tsx</h3>
          <p className="text-gray-400">
            Enable TypeScript support. When enabled, components will be copied
            as .tsx files.
          </p>
          ...
          <ul className="list-disc space-y-2 pl-6 text-gray-400">
            <li>
              <code className="rounded bg-[#1d1d1d] px-1.5 py-0.5">config</code>{' '}
              - Path to your Tailwind config file
            </li>
            <li>
              <code className="rounded bg-[#1d1d1d] px-1.5 py-0.5">css</code> -
          ...
          <ul className="list-disc space-y-2 pl-6 text-gray-400">
            ...
            <li>
              <code className="rounded bg-[#1d1d1d] px-1.5 py-0.5">utils</code>{' '}
              - Alias for utilities
            </li>
          </ul>
        </div>
