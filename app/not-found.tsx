...
const NotFound = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen bg-gradient-to-b from-white to-green-50 p-4 lg:p-16 gap-y-10 gap-x-10 lg:gap-x-40">
      <motion.div
