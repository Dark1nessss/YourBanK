...
export const authFormSchema = (type: string) =>
  z.object({
    ...
    postalCode:
      type === 'sign-in' ? z.string().optional() : z.string().min(5).max(5), // US ZIP code is 5 digits
    dateOfBirth: type === 'sign-in' ? z.string().optional() : z.string(), // FIX, must be a date plus needs updating in the frotend
