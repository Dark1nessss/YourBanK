...
const testimonials = [
  {
    quote:
      'YourBanK has transformed how we manage our business finances. The integration features are seamless.',
    author: 'Sarah Chen',
  ...
  {
    quote:
      "The security features give us peace of mind. Best banking platform we've ever used.",
  ...
  {
    quote:
      "Their customer support is exceptional. They're always there when you need them.",
  ...
  return (
    <div className="landing-page">
      ...
      <section
        id="hero"
        ref={targetRef}
        className="relative min-h-screen overflow-hidden bg-[#1a1f2d] py-20 sm:py-32"
      >
        <FloatingParticles />
              ...
              >
                ...
                >
                  ...
                  <span className="inline-block">
                    <span className="text-gradient bg-gradient-to-r from-[#39A36A] to-[#2970FF]">
                      Banking
                    </span>
                  </span>{' '}
                  For Everyone
                ...
                >
                  Experience the future of banking with YourBanK. Connect all
                  your accounts, create virtual cards, and manage your money
                  globally—all in one secure platform.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  {['Secure', 'FDIC Insured', '24/7 Support'].map(
                    (item, index) => (
                      <motion.div
                        key={item}
                        initial={{ opacity: 0, scale: 0.8 }}
      ...
      >
        ...
        >
          ...
          >
            Experience banking that`&apos;`s tailored to your individual needs
            with powerful features and personalized service.
          </motion.p>
        </motion.div>
              ...
              {[
                {
                  ...
                  description:
                    'Manage all your accounts in one place with our intuitive dashboard.',
                },
                {
                  icon: Smartphone,
                  title: 'Mobile Banking',
                  description:
                    'Bank on the go with our powerful mobile app available 24/7.',
                },
                {
                  icon: Gift,
                ...
                {[
                  {
                    ...
                    description:
                      'Dedicated business accounts with powerful features for smooth operations.',
                    features: [
                  ...
                  },
                  {
                    ...
                    title: 'Growth Tools',
                    description:
                      'Tools and insights to help your business grow and succeed.',
                    features: [
                  ...
                  },
                  {
                    ...
                    description:
                      'Send and receive payments globally with competitive rates.',
                    features: [
                  ...
                  },
                  {
                    ...
                    description:
                      'Advanced security features to protect your business finances.',
                    features: [
            ...
            {stats.map((stat, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-3xl font-bold text-white sm:text-4xl xl:text-5xl">
                    {stat.number}
                  </div>
      ...
      <section
        ref={featureRef}
        className="relative overflow-hidden bg-[#1a1f2d] py-24 sm:py-32"
      >
        <div className="container mx-auto max-w-[1400px] relative z-10">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Everything you need to manage your money in one place. Simple,
              ...
              {features.map((feature, index) => (
                ...
                >
                  <motion.div
                    ...
                    className={cn(
                      'mb-6 inline-block rounded-xl p-3',
                      feature.color
                    )}
                  >
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-400">
                        You received $1,000 from John Doe
                      </div>
                    </div>
                  </div>
                </motion.div>
            ...
            >
              ...
              <p className="mt-6 text-lg leading-relaxed text-gray-300">
                Download our mobile app to experience the future of banking.
                Manage your accounts, make payments, and track your spending—all
                from your phone.
              </p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
      ...
      <section
        id="cta"
        className="relative border-t border-gray-800 bg-[#1a1f2d] py-24"
      >
        ...
        <div className="container mx-auto max-w-[1400px] relative">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Join millions of people who trust YourBanK for their financial
              needs. Open your account in minutes.
            </p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <Link href="/contact">
                <Button
                  variant="outline"
                  size="lg"
                  className="group w-full text-white hover:bg-white/10 sm:w-auto"
                >
                  Contact Sales
                  <motion.span
                    initial={{ scale: 1 }}
